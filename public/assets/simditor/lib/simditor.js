(function() {
  ...
  Formatter = (function(_super) {
    ...
    Formatter.prototype._allowedTags = ['br', 'a', 'img', 'b', 'strong', 'i', 'u', 'p', 'ul', 'ol', 'li', 'blockquote', 'pre', 'h2', 'h3', 'h4'];
  ...
  Simditor.Toolbar.addButton(TitleButton);
    ...
    MoreButton = (function(_super) {
        __extends(MoreButton, _super);

        function MoreButton() {
            _ref17 = MoreButton.__super__.constructor.apply(this, arguments);
            return _ref17;
        }

        MoreButton.prototype.name = 'more';

        MoreButton.prototype.icon = 'terminal';

        MoreButton.prototype.title = '更多';

        MoreButton.prototype.htmlTag = 'more';

        MoreButton.prototype.status = function($node) {
            return true;
        };

        MoreButton.prototype.command = function() {
            ...
            $hr = $('<hr/>').addClass('more').insertAfter($rootBlock);
            if ($newBlock) {
    ...
    Simditor.Toolbar.addButton(MoreButton);
  ...
  CodePopover = (function(_super) {
    ...
    CodePopover.prototype.render = function() {
      ...
      return this.selectEl.on('change', function(e) {
        ...
        _this.target.removeClass('prettyprint').removeClass(oldLang).removeAttr('data-lang');
        if (_this.lang !== -1) {
          _this.target.addClass('prettyprint').addClass(lang);
